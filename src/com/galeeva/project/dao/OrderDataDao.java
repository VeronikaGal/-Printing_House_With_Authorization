...
public class OrderDataDao implements Dao<Long, OrderDataEntity> {
    ...
    public OrderDataEntity save(OrderDataEntity orderData) {
        try (var connection = ConnectionManager.get();
            ...
            prepareStatement.setObject(1, orderData.getUserId().getId());
            prepareStatement.setObject(2, orderData.getServiceId().getId());
    ...
    public void update(OrderDataEntity orderData) {
        try (var connection = ConnectionManager.get();
            ...
            prepareStatement.setLong(1, orderData.getUserId().getId());
